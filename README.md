...
2. Video **enhancement**  capabilities ( Night Vision, HD Resolution, etc. ) 
3. Object **Detection**
4. Facial **Recognition** 
5. Ability to capture **greater field of view** using a wide-lens camera
6. **Backup storage** using a standard database
